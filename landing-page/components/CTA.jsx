  ...
  return (
    <section className="py-20 px-4 max-w-7xl mx-auto border-t border-brand-border/40 flex justify-center">
      ...
      <div className="glass-panel-orange max-w-3xl w-full rounded-[32px] p-7 sm:p-16 flex flex-col items-center text-center shadow-xl shadow-brand-orange/5 relative overflow-hidden">
        ...
        {/* Heading */}
        <h2 className="font-heading text-3xl sm:text-5xl font-black text-gray-900 dark:text-white uppercase tracking-tight">
          READY TO START?
        </h2>

        {/* Subtitle */}
        <p className="mt-4 text-gray-600 dark:text-gray-400 text-sm sm:text-base max-w-md font-light leading-relaxed">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto px-4">
          <a
            href="#create-account"
            className="bg-brand-orange hover:bg-brand-orangeHover text-gray-900 dark:text-white px-8 py-4 rounded-xl font-heading text-xs sm:text-sm font-black tracking-widest transition-all duration-300 w-full sm:w-auto transform hover:scale-105 active:scale-95 shadow-lg shadow-brand-orange/25"
          >
            CREATE FREE ACCOUNT
          </a>
          <a
