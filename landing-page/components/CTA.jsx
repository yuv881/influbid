  ...
  return (
    <div className="bg-brand text-brand-ink text-center rounded-3xl mx-5 md:mx-8 mb-16 md:mb-[88px] px-5 py-12 md:px-8 md:py-[72px]">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-3.5">
        ...
        <button className="inline-flex items-center justify-center gap-2 px-7 py-[15px] rounded-[10px] bg-transparent text-brand-ink border-[1.5px] border-white/40 font-bold text-[15px] cursor-pointer transition-transform hover:-translate-y-px w-full md:w-auto">Sign in</button>
      </div>
    </div>
  );
}
