  ...
  return (
    <section className="relative pt-36 pb-20 px-4 overflow-hidden flex flex-col items-center text-center">
      ...
      <div className="max-w-4xl mx-auto z-10 flex flex-col items-center">
        {/* Live Campaign Pill */}
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-brand-teal/20 bg-brand-teal/5 text-brand-teal font-heading text-xxs sm:text-xs font-bold tracking-widest uppercase mb-8 shadow-sm shadow-brand-teal/5">
          <span className="h-2 w-2 rounded-full bg-brand-teal animate-pulse"></span>
          2,400+ Live Campaigns
        </div>

        {/* Big Impact Headings */}
        <h1 className="font-heading text-5xl sm:text-7xl md:text-8xl font-black tracking-tight leading-none text-white select-none">
          BRANDS MEET
        </h1>
        ...
        {/* Subtitle */}
        <p className="mt-8 text-gray-400 text-base sm:text-lg md:text-xl max-w-2xl font-light leading-relaxed">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto px-4">
          <a
            href="#post-campaign"
            className="flex items-center justify-center gap-3 bg-brand-orange hover:bg-brand-orangeHover text-white px-8 py-4 rounded-xl font-heading text-xs sm:text-sm font-black tracking-widest transition-all duration-300 w-full sm:w-auto transform hover:scale-105 active:scale-95 shadow-lg shadow-brand-orange/30 group"
          >
