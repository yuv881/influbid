...
const Header = () => {
  ...
  return (
    <header className="bg-white border-b border-gray-200 px-8 h-20 flex items-center justify-between shadow-sm sticky top-0 z-10 flex-shrink-0">
      <div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-blue-500 to-indigo-500 shadow-md flex items-center justify-center text-white font-bold cursor-pointer">
          Y
        </div>
      </div>
    </header>
